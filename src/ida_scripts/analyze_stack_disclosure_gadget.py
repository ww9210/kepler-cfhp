...
def main():
	...
	for ea in xref_copy_to_user:
		num_saved_registers, canary_location, canary_type, func_name\
			, data_flow_sig, reversed_instruction = analyze_one_xref(ea)
		output.append([num_saved_registers, canary_location, canary_type, func_name, data_flow_sig, reversed_instruction])
	#dump to result	
